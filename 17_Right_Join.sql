...
# Employee & salary
select * from gfg.employees right join gfg.salaries on gfg.employees.EmployeeID = gfg.salaries.EmployeeID;
select * from gfg.employees t1 right join gfg.salaries t2 on t1.EmployeeID = t2.EmployeeID;
select * from gfg.salaries t1 right join gfg.employees t2 on t1.EmployeeID = t2.EmployeeID;